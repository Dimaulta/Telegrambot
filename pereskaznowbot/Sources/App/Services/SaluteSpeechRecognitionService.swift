...
final class SaluteSpeechRecognitionService {
    ...
    func recognize(audioData: Data, mimeType: String?, logger: Logger) async throws -> String {
        ...
        guard var responseBody = response.body,
            ...
            throw Abort(.internalServerError, reason: "Нет ответа от SaluteSpeech при распознавании")
        }
        ...
        do {
            ...
            throw Abort(.internalServerError, reason: "Не удалось разобрать ответ SaluteSpeech")
        }
        ...
        guard response.status == .ok, recognitionResponse.status == 200 else {
            ...
            throw Abort(.internalServerError, reason: "SaluteSpeech ошибка распознавания: \(reason)")
        }
        ...
        throw Abort(.internalServerError, reason: "SaluteSpeech не вернул текст распознавания")
    }
