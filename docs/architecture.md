...
#### 4.3. SoranowBot (Порт 8086) 🚧 **В разработке**
...
#### 4.4. BananaNowBot (Порт 8088) 🚧 **В разработке**
...
#### 4.5. VeoNowBot (Порт 8087) 🚧 **В разработке**
...
#### 4.6. Neurfotobot (Порт 8082) ⏳ **Исследование**
...
#### 4.7. WmmoveBot (Порт 8084) ❄️ **Заморожен**
...
- `SORANOWBOT_TOKEN`, `SORANOWBOT_API_URL`, `SORANOWBOT_API_KEY`, `SORANOWBOT_HTTP_PROXY`, `SORANOWBOT_PROXY_*` — настройки SoranowBot 🚧
 - `BANANANOWBOT_TOKEN`, `BANANANOWBOT_PORT`, `BANANANOWBOT_NANO_API_KEY` — BananaNowBot 🚧
- `VEONOWBOT_TOKEN`, `VEONOWBOT_PORT`, `VEO3_API_KEY`, `VEO3_WORKFLOW_ID`, `VEO3_BASE_URL` — VeoNowBot 🚧
- `NEURFOTOBOT_TOKEN` — Neurfotobot ⏳
- `WMMOVEBOT_TOKEN` — WmmoveBot ❄️
