...
#### 4.7. Neurfotobot (Порт 8082) ⏳ **Исследование**
**Статус:** Создана базовая структура, ведётся исследование моделей и API

**Планируемое назначение:** Бот для нейрофотографий (AI обработка изображений)

**Текущее состояние:**
- Заданы контроллеры, модели и маршруты
- Интеграция с сервисами обработки изображений ещё не выполнена
...
- `NEURFOTOBOT_TOKEN` и связанные ключи (Replicate/Supabase) — Neurfotobot (исследование)
