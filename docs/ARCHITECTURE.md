...
#### 3.8. NowControllerBot (Порт 8084) 🛠️ **В разработке**
**Статус:** Проект в разработке, создан для управления отправкой сообщений в боты NowBots
...
- `NOWCONTROLLERBOT_TOKEN` — NowControllerBot (в разработке)
